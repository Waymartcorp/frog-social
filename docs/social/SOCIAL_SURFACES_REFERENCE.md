...
This file is a supporting reference for Frog Social surfaces and interactions.

Source of truth for Frog Social system behavior, learning model, case logic, and knowledge hierarchy:
- `docs/FROG_SOCIAL_INFORMATION_ECOSYSTEM.md`

Source of truth for husbandry doctrine:
